...
function draw_Mover_Pluma() {
  ...
  function draw_curvas_cuadraticas_bezier() {
    const canvas = document.getElementById("canvas_curvas_cuadraticas_bezier");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_curvas_cubicas_bezier() {
    const canvas = document.getElementById("canvas_curvas_cubicas_bezier");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_rectangulo() {
    const canvas = document.getElementById("canvas_rectangulo");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
...
draw_linea();
draw_arcos();
draw_curvas_cuadraticas_bezier();
draw_curvas_cubicas_bezier();
draw_rectangulo();
draw_path2D();